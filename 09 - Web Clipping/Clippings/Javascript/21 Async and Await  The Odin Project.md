---
title: "Async and Await | The Odin Project"
source: "https://www.theodinproject.com/lessons/node-path-javascript-async-and-await"
author:
published:
created: 2025-07-10
...
- [How do you declare an `async` function?](https://www.theodinproject.com/lessons/#the-async-keyword)
- [What does the `async` keyword do?](https://www.theodinproject.com/lessons/#the-async-keyword)
- [What does the `await` keyword do?](https://www.theodinproject.com/lessons/#the-await-keyword)
...
[Improve on GitHub](https://github.com/TheOdinProject/curriculum/edit/main/javascript/asynchronous_javascript_and_apis/async_and_await.md) [Report an issue](https://github.com/TheOdinProject/curriculum/issues/new?labels=Status%3A+Needs+Triage&lesson-link=https%3A%2F%2Fwww.theodinproject.com%2Flessons%2Fnode-path-javascript-async-and-await&template=suggestion.yaml&title=Async+and+Await%3A+%3CShort+description+of+your+suggestion%3E) [See lesson changelog](https://github.com/TheOdinProject/curriculum/commits/main/javascript/asynchronous_javascript_and_apis/async_and_await.md)
