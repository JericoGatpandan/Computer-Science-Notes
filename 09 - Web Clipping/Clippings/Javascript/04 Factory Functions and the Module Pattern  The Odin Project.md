---
title: "Factory Functions and the Module Pattern | The Odin Project"
source: "https://www.theodinproject.com/lessons/node-path-javascript-factory-functions-and-the-module-pattern"
author:
published:
created: 2025-06-17
...
- [How does scope work in JavaScript?](https://www.theodinproject.com/lessons/#scoopfuls-of-scopes)
- [What are closures and how do they help in creating private variables?](https://www.theodinproject.com/lessons/#closures-arent-scary)
- [What common issues can you face when working with constructors?](https://www.theodinproject.com/lessons/#so-whats-wrong-with-constructors)
- [What are private variables in factory functions and how can they be useful?](https://www.theodinproject.com/lessons/#private-variables-and-functions)
- [How can we implement prototypal inheritance with factory functions?](https://www.theodinproject.com/lessons/#prototypal-inheritance-with-factories)
- [How does the module pattern work?](https://dev.to/tomekbuszewski/module-pattern-in-javascript-56jm)
- [What does IIFE stand for and what are they?](https://www.theodinproject.com/lessons/#the-module-pattern-iifes)
- [What is the concept of namespacing and how do factory functions help with encapsulation?](https://www.theodinproject.com/lessons/#encapsulating-with-the-module-pattern)
...
[Improve on GitHub](https://github.com/TheOdinProject/curriculum/edit/main/javascript/organizing_your_javascript_code/factory_functions_and_module_pattern.md) [Report an issue](https://github.com/TheOdinProject/curriculum/issues/new?labels=Status%3A+Needs+Triage&lesson-link=https%3A%2F%2Fwww.theodinproject.com%2Flessons%2Fnode-path-javascript-factory-functions-and-the-module-pattern&template=suggestion.yaml&title=Factory+Functions+and+the+Module+Pattern%3A+%3CShort+description+of+your+suggestion%3E) [See lesson changelog](https://github.com/TheOdinProject/curriculum/commits/main/javascript/organizing_your_javascript_code/factory_functions_and_module_pattern.md)
