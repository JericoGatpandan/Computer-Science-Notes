---
title: "Objects and Object Constructors | The Odin Project"
source: "https://www.theodinproject.com/lessons/node-path-javascript-objects-and-object-constructors"
author:
published:
created: 2025-06-17
...
3. Read the article [\[\[Prototype\]\] vs **proto** vs.prototype in Javascript](https://medium.com/@eamonocallaghan/prototype-vs-proto-vs-prototype-in-javascript-6758cadcbae8)

The following questions are an opportunity to reflect on key topics in this lesson. If you can’t answer a question, click on it to review the material, but keep in mind you are not expected to memorize or master this knowledge.

- [How do you write an object constructor and instantiate the object?](https://www.theodinproject.com/lessons/#object-constructors)
- [How can you prevent that an object constructor is called without using the keyword `new`?](https://www.theodinproject.com/lessons/#safeguarding-constructors)
- [What is a prototype and how can it be used?](https://www.theodinproject.com/lessons/#the-prototype)
- [What is prototypal inheritance?](https://javascript.info/prototype-inheritance)
- [What are the basic do’s and don’t’s of prototypal inheritance?](https://www.theodinproject.com/lessons/#recommended-method-for-prototypal-inheritance)
...
[Improve on GitHub](https://github.com/TheOdinProject/curriculum/edit/main/javascript/organizing_your_javascript_code/objects_and_object_constructors.md) [Report an issue](https://github.com/TheOdinProject/curriculum/issues/new?labels=Status%3A+Needs+Triage&lesson-link=https%3A%2F%2Fwww.theodinproject.com%2Flessons%2Fnode-path-javascript-objects-and-object-constructors&template=suggestion.yaml&title=Objects+and+Object+Constructors%3A+%3CShort+description+of+your+suggestion%3E) [See lesson changelog](https://github.com/TheOdinProject/curriculum/commits/main/javascript/organizing_your_javascript_code/objects_and_object_constructors.md)
