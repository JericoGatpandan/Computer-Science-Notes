---
title: "Object Basics | The Odin Project"
source: "https://www.theodinproject.com/lessons/foundations-object-basics"
author:
published:
created: 2025-06-17
...
2. The [MDN tutorial on objects](https://developer.mozilla.org/en-US/docs/Learn/JavaScript/Objects/Basics) isn’t bad either, so check it out if you need another take on the subject.
...
2. Go back to the [JavaScript exercises repository](https://github.com/TheOdinProject/javascript-exercises). Review each README file prior to completing the following exercises in order:
	- `12_calculator`
	- `13_palindromes`
	- `14_fibonacci`
	- `15_getTheTitles`
...
[Improve on GitHub](https://github.com/TheOdinProject/curriculum/edit/main/foundations/javascript_basics/object_basics.md) [Report an issue](https://github.com/TheOdinProject/curriculum/issues/new?labels=Status%3A+Needs+Triage&lesson-link=https%3A%2F%2Fwww.theodinproject.com%2Flessons%2Ffoundations-object-basics&template=suggestion.yaml&title=Object+Basics%3A+%3CShort+description+of+your+suggestion%3E) [See lesson changelog](https://github.com/TheOdinProject/curriculum/commits/main/foundations/javascript_basics/object_basics.md)
