---
title: "Revisiting Rock Paper Scissors | The Odin Project"
...
```
maindevelopcommit1commit2commit1acommit2amerge to mainExample of Git Branching
```
...
- [What are branches in git?](https://www.theodinproject.com/lessons/#introduction)
- [How do you create a new branch?](https://www.theodinproject.com/lessons/#using-branches)
- [How do you merge a branch back into main?](https://www.theodinproject.com/lessons/#using-branches)
- [What is one use case for branches?](https://www.theodinproject.com/lessons/#sharing-code)
...
[Improve on GitHub](https://github.com/TheOdinProject/curriculum/edit/main/foundations/javascript_basics/revisiting_rock_paper_scissors.md) [Report an issue](https://github.com/TheOdinProject/curriculum/issues/new?labels=Status%3A+Needs+Triage&lesson-link=https%3A%2F%2Fwww.theodinproject.com%2Flessons%2Ffoundations-revisiting-rock-paper-scissors&template=suggestion.yaml&title=Revisiting+Rock+Paper+Scissors%3A+%3CShort+description+of+your+suggestion%3E) [See lesson changelog](https://github.com/TheOdinProject/curriculum/commits/main/foundations/javascript_basics/revisiting_rock_paper_scissors.md)
